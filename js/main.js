...
// Navigazione tra arrivo/partenza nei trasporti
...
// Gestione Sidebar Menù Principale
function openMenu() {
...
// Navigazione tra le Pagine "Info" e "Trasporti"
...
// Chiusura automatica e gestione di tutti i Drawers (i menù fluttuanti)
...
// Cliccare fuori chiude i menu fluttuanti
...
function applyTranslations(lang) {
  if (typeof T === 'undefined') return; // Sicurezza se manca il file delle traduzioni
  var t = T[lang];
  if (!t) return;
...
// Motore Header Scroll e Misurazioni
